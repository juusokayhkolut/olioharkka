...
public class ApiClient {
        public static CompletableFuture<JSONObject> searchForMunicipalityPopulation(String municipality) {
            // Prepare your data here, modify the list as needed
            List<String> alueValues = new ArrayList<>(Arrays.asList("SSS",
                    "KU020",
                    "KU005",
                    "KU009",
                    "KU010",
            ...
            return CompletableFuture.supplyAsync(() -> {
                ...
                try {
                    ...
                    String alueJsonArray = alueValues.stream()
                            .map(s -> "\"" + s + "\"")
                            .collect(Collectors.joining(", "));

                    String jsonInputString = "{"
                            + "\"query\": ["
                            + "    {\"code\": \"Alue\", \"selection\": {\"filter\": \"item\", \"values\": [" + alueJsonArray + "]}},"
